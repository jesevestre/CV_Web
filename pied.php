			...
			<div class="container text-center text-md-left">
				...
				<div class="row text-center text-md-left" style="margin-top: -35px;">
					...
					<div class="col-md-4 col-lg-4 col-xl-3 mx-auto mt-3">
						...
						<h5 class="text-uppercase mb-4 font-weight-bold" id="text-warning">Coordonnées</h5>
						<p>
							<i class="fas fa-phone-alt mr-3"></i>Téléphone: 06 04 46 03 91
						</p>
						<p>
							<i class="far fa-envelope mr-3"></i>Email:
							<a href="mailto:sevestre.jb@gmail.com" target="blank">
								sevestre.jb@gmail.com</a>
						</p>
						<p>
							<i class="fas fa-car mr-3"></i>Mobilité : permis BE
						</p>
						<p>
							<i class="fab fa-linkedin mr-3"></i>Profil 
							<a href="https://www.linkedin.com/in/jean-baptiste-sevestre-588674134/" target="blank">
							Linkedin </a><i class="fas fa-check"></i>
						</p>
						<p>
							<i class="fab fa-github mr-3"></i>Profil GitHub: 
