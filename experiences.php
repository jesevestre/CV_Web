        ...
        <div class="tabs-content">
            ...
            <div class="tab-content active" id="professionnelles"><p><b>Ingénieur développeur, CEA, Saclay (91)</b> Juillet 2021 - Juillet 2022</p>
                ...
                <ul>
                    ...
                    les clients. J’ai été en charge lors de ce projet du consulting data avec l’étude de 
                    mise en oeuvre, puis la conception de l’application en gestion du projet (logiciel Trello) 
            ...
            <div class="tab-content" id="stages"><p><b>Stagiaire en R&D, secteur du Diagnostic System, Groupe Renault, Guyancourt (78)
                ...
                <ul>
                    <li>•	Mise en place d'une application web avec une base de données permettant la gestion 
                        des retours usines sous forme de code erreur. Il a comme objectif d’automatiser et 
