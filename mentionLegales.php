...
<div class="tel-400px"></div>
    ...
    <h1>Mentions légales</h1>
        ...
        <p>Le responsable de la publication du site web est Monsieur <b>Jean-Baptiste SEVESTRE</b>, 
            en qualité de représentant légal en son nom propre,</p>

        <p>L’ensemble de ce site relève de la législation française sur le droit d’auteur et plus largement sur la propriété intellectuelle. 
            Tous les droits de reproduction, de représentation et de communication publique sont réservés, 
            y compris pour les documents téléchargeables et représentations visuelles, audiovisuelles, 
            photographiques, iconographies ou autres.</p> 

        <p><b>La reproduction de tout ou partie de ce site sur un support électronique, 
            quel qu’il soit, est formellement interdite</b> sauf autorisation expresse du directeur de la publication.</p>

        <p>Les marques citées sur le site sont déposées par les sociétés ou organismes qui en sont propriétaires. 
            Leur reproduction ou utilisation, de quelque sorte, est interdite sauf autorisation expresse.</p>
